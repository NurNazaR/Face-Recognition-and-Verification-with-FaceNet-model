...
class CamApp(App):
    def build(self):
        ...
        self.button = Button (text="Verify", on_press=self.who_is_it, size_hint=(1, .1))
        self.verification_label = Label(text ="Verification Uninitiated", size_hint= (1, .1))
        self.upload_button = Button(text='Upload Photo to Database', size_hint=(1, .1))
        ...
        self.model = model # tf.keras.models.load_model('model.keras', safe_mode = False)
    ...
    def show_file_chooser(self, instance):
        ...
        file_chooser.bind(on_submit=self.upload_photo)
        self.popup = Popup(title='Choose a Photo', content=file_chooser, size_hint=(0.8, 0.8))
        self.popup.open()
        
        
    def upload_photo(self, instance, path, filename):
        # Here, you can write the code to upload the photo to the database
        print(f"Uploading photo: {filename} from {path} to the database")
        
        # Close the popup after the photo is uploaded
        self.popup.dismiss()
